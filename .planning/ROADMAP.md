...
**Plans**: 5 plans across 3 waves
  - [x] 01-01-PLAN.md — Foundation install: pnpm.overrides alias + (marketing)/layout.tsx duplicate-html fix + stale "Artificial Societies" title removal + motionTokens.ts + _components/_data/_hooks/v3/placeholders directory scaffolds
...
**Plans**: 3 plans across 2 waves
  ...
  - [x] 02-03-PLAN.md — HeroSection + FinalCtaSection wrappers; rewire v3/page.tsx (replace Hero + Final CTA SectionShells, insert VisionBeat)
