...
**Plans**: 3 plans
- [ ] 01-01-PLAN.md — Live ingestion spike (resolve A1-A5: Clockworks contract, mp4 field, URL TTL, resolve+Omni latency vs maxDuration=300, C1 two-video differential) → 01-INGESTION-SPIKE.md [autonomous: false — billable live Apify run, gates the build]
...
|-------|----------------|--------|-----------|
| 1. Ingestion BUILD (HARD GATE) | 0/3 | Not started | - |
