...
- [x] 07-03-PLAN.md — `cloneTemplateAudience` template-clone helper (UX-04 / D-03)

**Wave 2** *(blocked on 07-01)*

- [x] 07-04-PLAN.md — Composer per-skill submit semantics + `activeMode` threading (UX-02 / D-07)
