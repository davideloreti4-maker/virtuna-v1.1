...
must_haves:
  ...
  key_links:
    ...
    - from: "src/components/app/test-creation-flow.tsx"
      ...
      via: "renders form when type is content-based"
      pattern: "ContentForm"
    - from: "src/components/app/test-creation-flow.tsx"
      to: "src/components/app/survey-form.tsx"
      via: "renders form when type is survey"
      pattern: "SurveyForm"
---
...
1. Create `src/components/app/test-creation-flow.tsx`:
   - Import both ContentForm and SurveyForm from @/components/app
...
2. Component structure based on currentStatus:
   ...
   - 'filling-form': Render appropriate form (ContentForm for most types, SurveyForm for survey type)
