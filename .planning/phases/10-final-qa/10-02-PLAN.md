...
6. **Document in structured format:**
  ...
  <verify>Discrepancy document exists with comparisons for forms, simulation, results, history</verify>
  <done>All dashboard content components documented with expected vs actual values</done>
</task>
