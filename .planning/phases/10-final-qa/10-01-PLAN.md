...
6. **Use v0 MCP to verify styling accuracy:**
  ...
  <verify>Discrepancy document exists with clear comparison table for each component</verify>
  <done>All dashboard shell components documented with expected vs actual values</done>
</task>
