...
**Scope Note (AN3):** Loading states in Phase 2 include Skeleton only. Spinner and Progress components are deferred to Phase 4+ when actual async operations require them. This keeps Phase 2 focused on foundational UI primitives.
</objective>
...
<task type="auto">
  ...
  <verify>
    ...
    2. Run `npm run dev` and create a quick test: import Button in page.tsx, hover over it to verify scale animation plays (visual confirmation of whileHover: scale 1.02)
  </verify>
  <done>Button component exports correctly, variants work, motion hover/tap animations verified in browser</done>
</task>
