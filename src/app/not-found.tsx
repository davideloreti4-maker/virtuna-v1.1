...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-3 bg-background px-4">
      ...
      <Link
        href="/"
        className="mt-4 inline-flex items-center justify-center rounded-lg bg-action px-5 py-2.5 text-sm font-medium text-action-foreground transition-colors hover:bg-action/90"
      >
        Go home
      </Link>
    </div>
