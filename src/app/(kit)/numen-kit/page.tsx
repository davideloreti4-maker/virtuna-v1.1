...
export default function NumenKitPage() {
  return (
    <div
      className={`numen-surface dark min-h-screen bg-numen-bg text-numen-text p-8 md:p-16 ${serifAlt.variable}`}
    >
      <header className="mb-16 max-w-2xl">
        <h1 className="text-3xl font-semibold text-numen-text">Numen Kit</h1>
        <p className="mt-3 text-base text-numen-text-muted">
      ...
      <section className="mb-16">
        <h2 className="mb-6 text-xl font-semibold text-numen-text">Tokens</h2>
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-6">
          {(
            [
              { label: "bg", cls: "bg-numen-bg", hex: "#1a1714" },
              { label: "panel", cls: "bg-numen-panel", hex: "#211e1a" },
              { label: "panel-2", cls: "bg-numen-panel-2", hex: "#2a2622" },
              { label: "text", cls: "bg-numen-text", hex: "#f0ebe3" },
              { label: "text-muted", cls: "bg-numen-text-muted", hex: "#bab2a5" },
              { label: "accent", cls: "bg-numen-accent", hex: "#d98a5e" },
            ] as const
          ).map((t) => (
            <div key={t.label} className="flex flex-col gap-2">
              <div
                className={`h-16 w-full rounded-[12px] border border-numen-border ${t.cls}`}
              />
              <div className="text-sm font-medium text-numen-text">{t.label}</div>
              <div className="text-sm text-numen-text-muted">{t.hex}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-16">
        <h2 className="mb-6 text-xl font-semibold text-numen-text">Verdict scale</h2>
        <p className="mb-6 max-w-2xl text-base text-numen-text-muted">
        ...
        <div className="flex flex-wrap items-end gap-8">
          {(
            ...
            <div key={v.verdict} className="flex flex-col items-center gap-2">
              ...
              <span className="text-sm font-medium text-numen-text">{v.label}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-16">
        <h2 className="mb-6 text-xl font-semibold text-numen-text">Surface & Glass</h2>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <Surface className="p-6">
            <h3 className="mb-2 text-base font-semibold text-numen-text">Surface</h3>
          ...
          <div className="relative overflow-hidden rounded-[12px]">
            ...
            <Glass className="relative m-6 p-6">
              <h3 className="mb-2 text-base font-semibold text-numen-text">Glass</h3>
              <p className="text-sm text-numen-text-muted">
      ...
      <section className="mb-16">
        <h2 className="mb-6 text-xl font-semibold text-numen-text">Tool chips</h2>
        ...
        <p className="mt-4 max-w-2xl text-sm text-numen-text-muted">
      ...
      <section className="mb-16">
        <h2 className="mb-6 text-xl font-semibold text-numen-text">Icon buttons</h2>
        <div className="flex flex-wrap items-center gap-4">
      ...
      <section className="mb-16">
        <h2 className="mb-6 text-xl font-semibold text-numen-text">
          Serif voice specimen
        </h2>
        <p className="mb-6 max-w-2xl text-sm text-numen-text-muted">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <Surface className="bg-[#1a1714] p-6">
            <div className="mb-4 text-sm font-medium text-numen-text-muted">
              Source Serif 4 (current --font-serif)
            </div>
            <p
              className="font-serif text-numen-text"
              style={{ fontSize: 28, fontWeight: 600, lineHeight: 1.2 }}
            >
              Welcome back — let’s read your latest.
            </p>
            <p
              className="mt-4 font-serif text-numen-text"
              style={{ fontSize: 28, fontWeight: 600, lineHeight: 1.2 }}
            >
          ...
          <Surface className="bg-[#1a1714] p-6">
            ...
            <p
              className="mt-4 text-numen-text"
              style={{
                fontFamily: "var(--font-serif-alt)",
                fontSize: 28,
                fontWeight: 600,
      ...
      <section className="mb-16">
        <h2 className="mb-6 text-xl font-semibold text-numen-text">Stage reveal</h2>
        <p className="mb-6 max-w-2xl text-sm text-numen-text-muted">
      ...
      <section className="mb-16" data-testid="ds08-keyframe-chroma">
        ...
        <div className="flex flex-wrap items-stretch gap-6">
          ...
          <img
            ...
            width={180}
            className="h-80 w-44 rounded-[12px] border border-numen-border object-cover"
          />
          {/* Near-neutral chrome container, DIRECTLY ADJACENT — it visibly recedes */}
          <div className="flex flex-1 flex-col gap-3 rounded-[12px] border border-numen-border bg-numen-panel p-6">
            <div className="text-base font-semibold text-numen-text">
              Reading chrome
            </div>
            <p className="text-sm text-numen-text-muted">
              Near-neutral panel — `bg-numen-panel` + `border-numen-border`. It steps back so
              the keyframe beside it reads as the only chroma in the frame.
            </p>
            <div className="mt-auto flex items-center gap-3">
              <VerdictSwatch verdict="mixed" size="md" />
              <span className="text-sm font-medium text-numen-text-muted">
                Mixed signals
              </span>
            </div>
          </div>
      ...
      <section className="mb-4">
        <Surface className="p-8 text-center">
          <h3 className="text-base font-semibold text-numen-text">Nothing here yet</h3>
          <p className="mt-2 text-sm text-numen-text-muted">
            This is a kit showcase — components render below under the Numen
            surface tokens.
          </p>
        </Surface>
