...
export function MagicCard(props: MagicCardProps) {
  const {
    ...
    className,
    gradientSize = 200,
    gradientColor = "#18191a",
    gradientOpacity = 0.6,
    gradientFrom = "#FF7F50",
    gradientTo = "rgba(255,127,80,0.15)",
    mode = "gradient",
  } = props
  ...
  // Raycast reduced-motion guard (UI-SPEC §Magic Card): when user prefers
  // reduced motion, disable the spring-tracked spotlight — render static card.
