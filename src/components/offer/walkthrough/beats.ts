...
export const BEATS: readonly Beat[] = [
  {
    id: "frames",
    kicker: "The video",
    headline: "29 seconds, read frame by frame.",
    body: "The line is measured attention. It starts falling immediately and never recovers — 65% are still there at the end.",
    cta: "Start with the hook",
    seal: "sealed",
    event: "demo_view",
  },
  {
    id: "revealed",
    kicker: "0:00 · the hook",
    headline: "Strong delivery. The subject arrives late.",
    body: "Here is the entire read on it — what happened, why, and the fix. Nothing held back.",
    cta: "Now the steepest drop",
    seal: "sealed",
    event: "demo_fix_open",
  },
  {
    id: "wall",
    kicker: "0:12 · the steepest drop",
    headline: "14 points of attention gone in one segment.",
