  ...
  return (
    <section className="relative min-h-screen bg-[#0d0d0d] pt-[66px] overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="flex items-center min-h-[calc(100vh-66px)] py-16 md:py-24">
          {/* 2-column layout */}
      ...
      {/* Decorative orange dots on left side */}
      <div className="absolute left-6 md:left-12 top-1/3 z-20 hidden lg:flex flex-col gap-2">
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="flex gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-[#E57850]/60" />
            <div className="w-1.5 h-1.5 rounded-full bg-[#E57850]/40" />
          </div>
        ))}
      </div>
        ...
        <Container>
          <div className="py-5">
            ...
            <div className="flex items-center justify-center gap-10 md:gap-14 mb-4">
              {/* Point72 Ventures */}
              <div className="flex items-center gap-2 text-[rgb(150,150,150)]">
            ...
            <div className="flex items-center justify-center gap-8 md:gap-12 flex-wrap">
              {/* Sequoia */}
              <div className="flex items-center gap-1.5 text-[rgb(130,130,130)]">
