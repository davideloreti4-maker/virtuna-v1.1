...
function buildThumbDots(count: number, seed: number, vbW: number, vbH: number): ConDot[] {
  ...
  for (let i = 0; i < dotCount; i++) {
    ...
    // designed constellation rather than a faint even scatter (folds the approved seed).
...
function ThumbConstellation({
  ...
  return (
    <svg
      ...
      aria-hidden
    >
      {/* Faint constellation edges — connect consecutive nodes into a path (drawn under
          the dots). Reinforces the identity motif vs. a loose dot scatter (seed). */}
