...
export function Reading() {
  ...
  // the branded skeleton (real-signal liveness), NOT a fabricated 0-gauge and NOT
  // "couldn't analyze".
  const processing =
  ...
  // Phase-4 settle cascade (REVEAL-01): after a live wait (skeleton was shown) the
  // core blocks fade+rise in with a staggered delay so the thread reads as building,
  // then settles. CSS `.reading-reveal` is reduced-motion-gated. A cold permalink
  // reload of an already-complete Reading skips this and appears at rest.
