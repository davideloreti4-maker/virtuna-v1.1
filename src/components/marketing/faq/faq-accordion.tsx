...
const FAQ_ITEMS: readonly FaqItem[] = [
  ...
  },
  {
    ...
    a: "Not a free one — a $1 one. Any plan starts at $1 for 3 days, with everything that plan includes unlocked. It renews at the plan price on day 4 unless you cancel, and you can cancel any time from settings. We'd rather charge you a dollar and show you the real product than hand you a crippled free tier.",
  },
  {
    id: "faq-duration",
