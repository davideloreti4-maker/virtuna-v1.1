    ...
    >
      ...
      <div className="flex flex-col items-center gap-1">
        <button
          ...
          className="text-xs text-foreground-muted transition-colors hover:text-foreground-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--focus-ring)] rounded-sm px-1 py-0.5"
        >
          Skip this question
        </button>
        {showSkipAll && (
