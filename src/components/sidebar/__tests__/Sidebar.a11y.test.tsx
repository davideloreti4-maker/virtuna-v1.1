...
describe('Sidebar a11y', () => {
  ...
  it('exposes top-level nav items: New Thread, Audience, Library, Feed + the surfaced routes (IA-01)', () => {
    render(<Sidebar />);
    // Top-level nav nouns: New Thread (CTA) + Grow (hub) · Audience · Library · Feed ·
    // Competitors. Analytics + Referrals are folded into the Grow hub (Surfaces IA) and
    // are no longer standalone nav items.
    ...
    // Collapsed into the Grow hub → no longer standalone nav items.
